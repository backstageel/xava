                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <span class="text-secondary">{{$supplier->supplierable->address_country_id}}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <h6 class="mb-0">provincia</h6>
                                    <span class="text-secondary">{{$supplier->supplierable->address_province_id}}</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <h6 class="mb-0">nacionalidade</h6>
                                    <span class="text-secondary">{{$supplier->supplierable->address_district_id}}</span>
                                </li>
