...
@section("wrapper")
    ...
    <div class="row">
        <div class="col-xl-12 mx-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <x-bootstrap::form.form method='PUT' class="row g-3" action="{{route('profile.update', $employee)}}"
                                    ...
                                    <div class="row">
                                        <div class="col-2">
                                            <x-bootstrap::form.select name="gender_id" label="Gênero"
                                                                      :options="$genders"
                                                                      :default="$employee->person->gender_id"/>
                                        </div>
                                        <div class="col-3">
                                        ...
                                        <div class="col-2">
                                            <x-bootstrap::form.select name="civil_state_id" label="Estado Civil"
                                                                      :options="$civilStates"
                                                                      :default="old('civil_state_id',$employee->person->civil_state_id)"/>
                                        </div>
                                        <div class="col-5">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <x-bootstrap::form.input name="address" label="Endereço de Morada"
                                                                     :value="old('address',$employee->person->address)"/>
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <x-bootstrap::form.input name="emergency_phone"
                                                                         label="Telemóvel para Emergencias"
