...
@section("wrapper")
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Editar Férias Coletivas</div>
        <div class="ps-3">
    ...
    <div class="row">
        <div class="col-xl-12 mx-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <x-bootstrap::form.form class="row g-3" method="PUT" action="{{route('vacation_collectives.update', $vacation_collective)}}">
                        <!-- SmartWizard html -->
                        <div id="smartwizard">
                            <ul class="nav">
                                <li class="nav-item">
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <x-bootstrap::form.date-picker name="start_date" label="Dia de inicio"
                                                                           :default="$vacation_collective->start_date"
                                                                           required/>
                                        </div>
                                        <div class="col-4">
                                            <x-bootstrap::form.date-picker name="end_date" label="Dia de Fim"
                                                                           :default="$vacation_collective->end_date"
                                                                           required/>
                                        </div>
                                    </div>
                                </div>
