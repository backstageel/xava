<table >
    ...
    <tr>
        <th colspan="6">
            <strong>Objectivo de Vendas de Equipamento Electrónico</strong>
        </th>
    </tr>
    ...
    <tr>
        ...
        <th>{{$computer_equipament_sales * 100/$limit}}%</th>
        <th>{{$on_going_computer_equipament_sales * 100/$limit}}%</th>
        <th>{{$paid_computer_equipament_sales * 100/$limit}}%</th>
    </tr>
    ...
    @endforeach
        <tr>
            ...
            <th><strong>{{$computer_equipament_sales}}</strong></th>
            <th><strong>{{$on_going_computer_equipament_sales}}</strong></th>
            <th><strong>{{$paid_computer_equipament_sales}}</strong></th>
