                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <h6 class="mb-0"></h6>
                                    <span class="text-secondary"><button class="btn btn-primary">Adicionar Objecto Social</button></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary mb-3">
                                    <input onclick='Livewire.emit("openModal", "add-individual-partner", {{ json_encode(["companyId" => $company->id]) }})' type="button" class="btn btn-primary px-4" value="Adicionar Personalidade" />
