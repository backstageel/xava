                ...
                <div class="col col-lg-9 mx-auto">
                    ...
                    <div class="card radius-10">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row row-cols-auto g-3">
                                <div class="col">
                                    <button type="button" class="btn btn-outline-primary px-5 radius-30">Primary
                                    </button>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    <button type="button" class="btn btn-outline-success px-5 radius-30">Success
                                    </button>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    <button type="button" class="btn btn-outline-warning px-5 radius-30">Warning
                                    </button>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    <button type="button" class="btn btn-outline-secondary px-5 radius-30">Secondary
                                    </button>
                                </div>
                                <div class="col">
                    ...
                    <div class="card radius-10">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row row-cols-auto g-3">
                                <div class="col">
                                    <button type="button" class="btn btn-outline-primary px-5 rounded-0">Primary
                                    </button>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    <button type="button" class="btn btn-outline-success px-5 rounded-0">Success
                                    </button>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    <button type="button" class="btn btn-outline-warning px-5 rounded-0">Warning
                                    </button>
                                </div>
                                <div class="col">
                                ...
                                <div class="col">
                                    <button type="button" class="btn btn-outline-secondary px-5 rounded-0">Secondary
                                    </button>
                                </div>
                            </div>
                            <!--end row-->
                    ...
                    <div class="card radius-10">
                        <div class="card-body">
                            ...
                            <div class="row row-cols-auto g-3">
                                <div class="col">
                                    <button type="button" class="btn btn-primary px-5"><i class='bx bx-user mr-1'></i>Person
                                    </button>
                                </div>
                                <div class="col">
                                    <button type="button" class="btn btn-danger px-5"><i
                                            class='bx bx-bookmark mr-1'></i>Bookmark
                                    </button>
                                </div>
                                <div class="col">
                                    <button type="button" class="btn btn-success px-5"><i class='bx bx-home mr-1'></i>Home
                                    </button>
                                </div>
                                <div class="col">
                                    <button type="button" class="btn btn-info px-5"><i
                                            class='bx bx-cloud-download mr-1'></i>Downloads
                                    </button>
                                </div>
                                <div class="col">
                                    <button type="button" class="btn btn-warning px-5"><i
                                            class='bx bx-heart-circle mr-1'></i>Love
                                    </button>
                                </div>
                                <div class="col">
                                    <button type="button" class="btn btn-dark px-5"><i
                                            class='bx bx-cloud-upload mr-1'></i>Upload
                                    </button>
                                </div>
                                <div class="col">
                                    <button type="button" class="btn btn-secondary px-5"><i
                                            class='bx bx-comment mr-1'></i>Comments
                                    </button>
                                </div>
                                ...
                                <div class="col">
                                    <button type="button" class="btn btn-lg btn-primary px-5"><i
                                            class='bx bx-user mr-1'></i>Person
                                    </button>
                                </div>
                                <div class="col">
                            ...
                            <div class="row row-cols-auto g-3">
                                ...
                                <div class="col">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        ...
                                        <button type="button" class="btn btn-danger"><i
                                                class='bx bx-search-alt me-0'></i>
                                        </button>
                                        <button type="button" class="btn btn-danger"><i
                                                class='bx bx-rotate-right me-0'></i>
                                        </button>
                                ...
                                <div class="col">
                                    <div class="btn-group-vertical" role="group" aria-label="Vertical button group">
                                        ...
                                        <button type="button" class="btn btn-dark"><i
                                                class='bx bx-paper-plane me-0'></i>
                                        </button>
                                ...
                                <div class="col">
                                    <div class="dropdown">
                                        <button class="btn btn-danger dropdown-toggle" type="button"
                                                data-bs-toggle="dropdown" aria-expanded="false">Danger
                                        </button>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="#">Action</a>
                                            </li>
